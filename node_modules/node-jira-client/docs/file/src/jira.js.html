...
<head>
  ...
  <title data-ice="title">src/jira.js | node-jira-client</title>
...
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import request from &apos;request-promise&apos;;
import url from &apos;url&apos;;
